...
from .beast_math import bearing_deg, haversine_km, project_position
...
class BeastAircraftDecoder:
    ...
    def _safe(fn, *args, **kwargs):
        # ⚡ Bolt Optimization: Accept function references and arguments directly rather
        # than using lambdas. This avoids dynamic closure creation overhead in the
        # high-frequency ADSB decode loop, saving time per parsed frame.
        try:
